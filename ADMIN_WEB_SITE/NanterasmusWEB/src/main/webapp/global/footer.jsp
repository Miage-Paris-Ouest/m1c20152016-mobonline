...
<%@include file="directivesInclude.jsp" %>
                                <div class="footer">
                                    ...
                                    <p class="pull-right"><bean:message key="footer.developp"/> <a href="mailto:florianroy@laposte.net">Florian ROY</a>,<a href="bru.veraldi@hotmail.fr">Bruno VERALDI</a>, <a href="mailto:adriendossantos29@gmail.com">Adrien DOS SANTOS</a></p>
                                    </p>
                                </div>
                           </div>
                        </div>		        
